...
- Kartica `Statistika` prikazuje statistiku samo trenutnog natjecanja: ukupnu i prosječnu službenu kilažu, najveći pojedinačni ulov, kilažu pobjedničke ekipe, sektorske sažetke i donut graf udjela sektora u ukupnoj kilaži. Žuti karton ulazi s umanjenom kilažom, regularnih 0 g ulazi u prosjek, a crveni karton i `bez člana` isključeni su iz kilaže i prosjeka.
